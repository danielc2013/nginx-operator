...
import (
	...
	cachev1alpha1 "github.com/danielc2013/nginx-operator/pkg/apis/cache/v1alpha1"
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &cachev1alpha1.Nginx{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
...
func newPodForCR(cr *cachev1alpha1.Nginx) *corev1.Pod {
